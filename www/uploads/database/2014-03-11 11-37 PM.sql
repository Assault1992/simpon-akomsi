...
#
# TABLE STRUCTURE FOR: pp_portfolio
#

DROP TABLE IF EXISTS pp_portfolio;

CREATE TABLE `pp_portfolio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `year` int(11) NOT NULL,
  `project` varchar(128) NOT NULL,
  `as` varchar(64) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO sys_setting (`id`, `key`, `type`, `value`) VALUES (1, 'site name', 'text', 'project gallery');
INSERT INTO sys_setting (`id`, `key`, `type`, `value`) VALUES (2, 'year', 'numeric', '2014');
INSERT INTO sys_setting (`id`, `key`, `type`, `value`) VALUES (3, 'author', 'text', 'ryan hs &lt;mr.ryansilalahi@gmail.com&gt;');
...
INSERT INTO sys_user (`id`, `group`, `name`, `username`, `email`, `password`, `token`) VALUES (1, 1, 'dev', 'dev', 'dev@ngesruk.com', 'dev', '9272f3c5660e4367634c3f640ca60af1');
INSERT INTO sys_user (`id`, `group`, `name`, `username`, `email`, `password`, `token`) VALUES (2, 2, 'admin default', 'admin', 'admin@ngesruk.com', 'admin', '3dd817ec1394f9b9839be3745c494634');
