...
<div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            <!-- /.box-header -->
            <div class="box-body">
		<h4 class="">Tambah Penginapan</h4>
		<hr noshade>
		<form action="<?php echo base_url('index.php/' . $this->sys_user->user_data()->group_name . '/ledging_management/add'); ?>" method="post" enctype="multipart/form-data">
