<div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            <!-- /.box-header -->
            <div class="box-body">
		<h4 class="">Tambah Venue</h4>
		<hr>
		
		<form action="<?php echo base_url('index.php/' . $this->sys_user->user_data()->group_name . '/venue_management/add'); ?>" method="post">
			...
			<div class="form-group">
				<?php $field = 'coordinate'; $name = $field; ?>
					...
					<input type="text" class="form-control" name="<?php echo $field; ?>" value="<?php echo set_value($field, ''); ?>" placeholder="Cth : -6.902515, 107.618780"/>
				<?php echo form_error($field, '<font style="color:red;">', '</font>'); ?>
			</div>
