<div class="row">
        <div class="col-xs-12">
          <div class="box box-warning">
            <!-- /.box-header -->
            <div class="box-body">
	<h4 class="">Edit Catering : <?php echo $data->name; ?></h4>
	<hr >
	
		<form action="<?php echo base_url('index.php/' . $this->sys_user->user_data()->group_name . '/catering_management/edit/' . $data->id); ?>" method="post">
			...
			<div class="form-group">
				<?php $field = 'id_kitchen'; $alias = $field; ?>
