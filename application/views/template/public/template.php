    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <img src="<?php echo base_url('admin/images/logopon.png'); ?>" width="60" height="60" class="user-image" alt="User Image">
          <!-- <a class="navbar-brand" href="index.html">SOLID.</a> -->
        </div>

        <div id="tulisan">
          <h2>PEKAN OLAHRAGA NASIONAL XIX 2016</h2>
        </div><!--/.nav-collapse -->
	 	...
	 	<div class="container">
		 	<div class="row">
		 		...
		 		<div class="col-lg-4">
                    ...
                    <div class="hline-w"></div>
                    <p>
                        Copyright &copy; 2016 <a href="http://diskumkm.jabarprov.go.id/">Dinas KUMKM Provinsi Jawa Barat</a>. <br>All rights reserved.
                    </p>
                </div>
